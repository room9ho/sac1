...
def test_single_layer():
    tar_layer = create_layer(("some_file", b"foo"), ("another_file", b"bar"), ("third_file", b"meh"))
...
def test_deleted_readded_file():
    ...
    second_layer = create_layer(("some_file", b"foo"), ("another_file", None), ("third_file", b"meh"))
...
def test_deleted_in_lower_layer():
    ...
    second_layer = create_layer(("some_file", b"foo"), ("deleted_file", None), ("third_file", b"meh"))
